...
(function($) {
	...
	$.fn.combobox.parseOptions = function(_66) {
		var t = $(_66);
		return $.extend({}, $.fn.combo.parseOptions(_66), $.parser
						.parseOptions(_66, ["valueField", "textField",
	...
	$.fn.combobox.parseData = function(_67) {
		...
		function _6b(el, _6c) {
			var t = $(el);
			var row = {};
			row[_69.valueField] = t.attr("value") != undefined ? t
					.attr("value") : t.text();
			...
			for (var i = 0; i < _71.length; i++) {
				...
				if (g) {
					if (_74 != g) {
						...
						dd
								.push("<div id=\""
										+ (_72.groupIdPrefix + "_" + (_72.groups.length - 1))
										+ "\" class=\"combobox-group\">");
						dd.push(_73.groupFormatter ? _73.groupFormatter.call(
								_6f, g) : g);
						dd.push("</div>");
					} else {
				...
				var cls = "combobox-item"
						...
						+ (g ? " combobox-gitem" : "");
				dd.push("<div id=\"" + (_72.itemIdPrefix + "_" + i)
						+ "\" class=\"" + cls + "\">");
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		finder : {
			...
			getRow : function(_8a, p) {
				...
				var _8c = (p instanceof $) ? p.attr("id")
						.substr(_8b.itemIdPrefix.length + 1) : _1(_8a, p);
