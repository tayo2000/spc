...
(function($) {
	...
	function _9(_a) {
		...
		function _f(_11) {
			...
			var _12, top;
			var _13 = $.isFunction(_c.deltaX)
					? _c.deltaX.call(_a, _c.position)
					: _c.deltaX;
			var _14 = $.isFunction(_c.deltaY)
					? _c.deltaY.call(_a, _c.position)
					: _c.deltaY;
			if (_c.trackMouse) {
				t = $();
	...
	function _19(_1f, _20) {
		...
		var cc = typeof _22.content == "function"
				? _22.content.call(_1f)
				: _22.content;
	...
	$.fn.tooltip.parseOptions = function(_2b) {
		var t = $(_2b);
		var _2c = $.extend({}, $.parser.parseOptions(_2b, ["position",
