...
(function($) {
	...
	function _b(_c, _d) {
		...
		if (!_e.data("menu")) {
			_e.data("menu", {
						options : $.parser.parseOptions(_e[0], ["width",
										"height"])
					});
		}
	...
	function _f(_12, div, _13) {
		...
		if (!_14.hasClass("menu-sep")) {
			...
			_14.empty().append($("<div class=\"menu-text\"></div>")
					.html(_15.text));
			if (_15.iconCls) {
	...
	function _3b(_3c, _3d) {
		...
		_40.show(0, function() {
					...
					_40[0].shadow.css({
								display : (_40.hasClass("menu-inline")
										? "none"
										: "block"),
			...
			return jq.each(function() {
						...
						if (_68.iconCls) {
							$("<div class=\"menu-icon\"></div>")
									.addClass(_68.iconCls).appendTo(_68.target);
						}
					});
		},
