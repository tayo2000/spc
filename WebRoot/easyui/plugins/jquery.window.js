...
(function($) {
	...
	function _11(_12) {
		...
		var win = $(_12).panel($.extend({}, _13.options, {
			...
			cls : "window "
					+ (!_14.border
							? "window-thinborder window-noborder "
	...
	function _21(_22) {
		...
		_23.window.draggable({
					...
					onBeforeDrag : function(e) {
						if (_23.mask) {
							_23.mask.css("z-index",
									$.fn.window.defaults.zIndex++);
						}
						if (_23.shadow) {
							_23.shadow.css("z-index",
									$.fn.window.defaults.zIndex++);
						}
						_23.window
		...
		_23.window.resizable({
					disabled : _23.options.resizable == false,
		...
		function _24(e) {
			...
			_23.pmask = $("<div class=\"window-proxy-mask\"></div>")
					.insertAfter(_23.window);
			_23.pmask.css({
						display : "none",
						zIndex : $.fn.window.defaults.zIndex++,
						left : e.data.left,
			...
			_23.proxy = $("<div class=\"window-proxy\"></div>")
					.insertAfter(_23.window);
			_23.proxy.css({
						display : "none",
						zIndex : $.fn.window.defaults.zIndex++,
		...
		function _25(e) {
			$.extend(e.data, _19.call(_22, e.data.left, e.data.top,
	...
	$(function() {
				if (!$._positionFixed) {
					$(window).resize(function() {
						...
						setTimeout(function() {
									$("body>div.window-mask:visible")
											.css($.fn.window.getMaskSize());
								}, 50);
					});
				}
			});
	...
	$.fn.window.parseOptions = function(_30) {
		return $.extend({}, $.fn.panel.parseOptions(_30), $.parser
						.parseOptions(_30, [{
											draggable : "boolean",
											resizable : "boolean",
											shadow : "boolean",
