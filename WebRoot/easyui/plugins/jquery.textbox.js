...
(function($) {
	...
	function _6(_7) {
		...
		if (_9.multiline) {
			...
			$("<input id=\"" + _a + "\" type=\"" + _9.type
					+ "\" class=\"textbox-text\" autocomplete=\"off\">")
					.prependTo(tb);
		}
		$("#" + _a).attr("tabindex", $(_7).attr("tabindex") || "").css(
				"text-align", $(_7).css("text-align"));
		...
		if (_9.label) {
			if (typeof _9.label == "object") {
				...
				$(_8.label).remove();
				_8.label = $("<label class=\"textbox-label\"></label>")
						.html(_9.label);
	...
	function _11(_12, _13) {
		...
		if (_15.label && _15.labelPosition) {
			if (_15.labelPosition == "top") {
				_14.label._size({
							width : _15.labelWidth == "auto"
									? tb.outerWidth()
									: _15.labelWidth
						}, tb);
				if (_15.height != "auto") {
					tb._size("height", tb.outerHeight()
									- _14.label.outerHeight());
				}
			} else {
				_14.label._size({
							width : _15.labelWidth,
		...
		var _1b = tb.width() - _1a.length * _15.iconWidth - _1c("left")
				- _1c("right");
		var _1d = _15.height == "auto" ? _18.outerHeight() : (tb.height()
				- _1c("top") - _1c("bottom"));
		_19.css(_15.iconAlign, _1c(_15.iconAlign) + "px");
		_19.css("top", _1c("top") + "px");
		_1a.css({
					width : _15.iconWidth + "px",
					height : _1d + "px"
				});
		_18.css({
	...
	function _26(_27) {
		...
		if (!_29.disabled && !_29.readonly) {
			...
			for (var _2b in _29.inputEvents) {
				_2a.bind(_2b + ".textbox", {
							target : _27
						}, _29.inputEvents[_2b]);
			}
		}
		var _2c = tb.find(".textbox-addon");
		_2c.unbind().bind("click", {
					target : _27
				}, function(e) {
					var _2d = $(e.target)
	...
	function _e(_39, _3a) {
		...
		tb.removeClass("textbox-readonly").addClass(_3c.readonly
				? "textbox-readonly"
				: "");
	};
	...
	$.fn.textbox.methods = {
		...
		getTipX : function(jq, _58) {
			...
			if (_58 == "right") {
				return (_5a.iconAlign == "right" ? _5c : 0)
						+ (_5a.buttonAlign == "right" ? _5d : 0) + 1;
			} else {
				if (_58 == "left") {
					return (_5a.iconAlign == "left" ? -_5c : 0)
							+ (_5a.buttonAlign == "left" ? -_5d : 0) - 1;
				} else {
					return _5c / 2 * (_5a.iconAlign == "right" ? 1 : -1) + _5d
							/ 2 * (_5a.buttonAlign == "right" ? 1 : -1);
				}
			}
		},
	...
	$.fn.textbox.parseOptions = function(_65) {
		var t = $(_65);
		return $.extend({}, $.fn.validatebox.parseOptions(_65), $.parser
						.parseOptions(_65, ["prompt", "iconCls", "iconAlign",
