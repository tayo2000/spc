...
(function($) {
			...
			if (ck.hasClass("tree-checkbox1")) {
				...
				if (ck.hasClass("tree-checkbox0")) {
					...
					if (_3b._checked == undefined) {
						_3b._checked = $(_36).find(".tree-checkbox")
	...
	function _4f(_50, _51) {
		...
		if (_52.view.hasCheckbox(_50, _54)) {
			if (!ck.length) {
				...
				$("<span class=\"tree-checkbox\"></span>").insertBefore(_53
						.find(".tree-title"));
			}
	...
	function _56(_57, ul, _58, _59, _5a) {
		...
		if (!_59) {
			...
			if (_5e) {
				_5e.children
						? _5e.children = _5e.children.concat(_58)
						: _5e.children = _58;
			} else {
	...
	function _61(_62, ul, _63) {
		...
		var _69 = $(ul).children("li:last").children("div.tree-node")
				.addClass("tree-node-last");
		_69.children("span.tree-join").removeClass("tree-join")
	...
	function _a7(_a8, _a9) {
		...
		if (_aa) {
			if (!_aa.children || !_aa.children.length) {
				var _ab = $(_aa.target);
				_ab.find(".tree-icon").removeClass("tree-folder")
						.addClass("tree-file");
		...
		update : function(jq, _115) {
			return jq.each(function() {
				_60(this, $.extend({}, _115, {
					checkState : _115.checked
							? "checked"
							: (_115.checked === false ? "unchecked" : undefined)
				}));
			});
		},
