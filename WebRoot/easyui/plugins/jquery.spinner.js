	...
	function _1(_2) {
		...
		if (_4.spinAlign == "left" || _4.spinAlign == "right") {
			...
			var _6 = {
				...
				handler : function(e) {
					var _7 = $(e.target)
							.closest(".spinner-arrow-up,.spinner-arrow-down");
					...
					onResize : function(_8, _9) {
						if (!_4.spinArrow) {
							...
							if (_b.length) {
								...
								var _e = _a.find(".spinner-button."
										+ _4.clsLeft);
								var _f = _a.find(".spinner-button."
										+ _4.clsRight);
		...
		if (_4.spinArrow) {
			...
			var _11 = $("<a href=\"javascript:;\" class=\"textbox-button spinner-button\"></a>")
					.addClass(_4.clsLeft).appendTo(_3.spinner);
			var _12 = $("<a href=\"javascript:;\" class=\"textbox-button spinner-button\"></a>")
