			...
			if (_1c.noheader || (!_1c.title && !_1c.header)) {
				...
				if (_1c.header) {
					...
					if (!$.isArray(_1c.tools)) {
						_23.find("div.panel-tool .panel-tool-a")
								.appendTo(_1c.tools);
					}
					_23.empty();
					var _24 = $("<div class=\"panel-title\"></div>")
							.html(_1c.title).appendTo(_23);
					if (_1c.iconCls) {
						_24.addClass("panel-with-icon");
						$("<div class=\"panel-icon\"></div>")
								.addClass(_1c.iconCls).appendTo(_23);
					}
					var _25 = $("<div class=\"panel-tool\"></div>")
							.appendTo(_23);
						...
						if ($.isArray(_1c.tools)) {
							...
							$(_1c.tools).children().each(function() {
								$(this).addClass($(this).attr("iconCls"))
										.addClass("panel-tool-a").appendTo(_25);
							});
						}
					}
					if (_1c.collapsible) {
	...
	function _29(_2a, _2b) {
		...
		if (!_2c.isLoaded || !_2d.cache) {
			...
			if (_2d.loadingMessage) {
				$(_2a).panel("clear");
				$(_2a).html($("<div class=\"panel-loading\"></div>")
						.html(_2d.loadingMessage));
			}
	...
	$.fn.panel = function(_68, _69) {
		...
		return this.each(function() {
					...
					if (_6a) {
						...
						_6b = $.extend({}, $.fn.panel.defaults, $.fn.panel
			...
			return jq.each(function() {
				...
				function _74(_75, _76) {
					...
					var s = $(_75)
							...
							.filter(function(_78, el) {
								var p = $(el).parents(".panel-" + _76
										+ ":first");
