...
<body  class="easyui-layout"  style="overflow-y: scroll">
	<table id="dg" title="质量特性列表 " class="easyui-datagrid" style="width:100%;height:auto"
		   url="featureList.action"
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<a class="easyui-linkbutton" iconCls="icon-add"    plain="true" onclick="addFeature()">添加</a>
